...
//               if(peopleList.get(i).loginCredentials.getUserName().equalsIgnoreCase(username) && peopleList.get(i).loginCredentials.getPassword().equalsIgnoreCase(password) && peopleList.get(i).isCommunityAdmin()){
//                return true;  
//             }
//        }
